...
import mess from "../images/xabar_white.png"
                                    ...
                                    <div className="details">
                                        <div className="details_content">
                                            ...
                                            <div className="details_btn">
                                                <button className='det_btn'><NavLink to="/xabarDoc"> Xabarlashish</NavLink></button>
                                            </div>
