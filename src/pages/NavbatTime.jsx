...
import tel from "../images/time_yel.png"
import mess from "../images/time_mess.png"
import video from "../images/time_video.png"
                    ...
                    <div className="container">
                        <div className="bac_img">
                            <div className="docPro_header">
                                <NavLink to="/malumot"> <img src={strelkaBlack} alt="" /></NavLink>
                            ...
                            <div className="blue_wrapper">
                                <div className="blue_logo">
                                  ...
                                  <NavLink to="/timeXabar"><img src={mess} alt="" /></NavLink>  
                                   <NavLink to="/timeVideo"><img src={video} alt="" /></NavLink> 
                                    <img src={time} alt="" />
                                ...
                                <div className="details">
                                    <div className="details_content">
                                        ...
                                        <div className="details_btn">
                                            <button className='det_btn'><NavLink to="/telDoc">Qo'ng'iroq qilish</NavLink></button>
                                        </div>
